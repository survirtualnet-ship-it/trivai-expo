...
import { MapEmbed, type MapEmbedRef } from '@/components/MapEmbed'
...
export function MapScreen() {
  ...
  const mapEmbedRef = useRef<MapEmbedRef>(null)
  ...
  const html = useMemo(
    ...
    [displayPlaces, selectedPlaceId, mapCenter],
  )
  ...
  const handleAnimateMap = useCallback((placeId: string) => {
    mapEmbedRef.current?.focusPlace(placeId)
  }, [])
  ...
  } = useMapSync({ carouselRef, onAnimateMap: handleAnimateMap })
